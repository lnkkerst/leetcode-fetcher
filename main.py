...
suffixMap = {"C++": ".cpp", "Python3": ".py", "Python": ".py", "MySQL": ".sql", "Go": ".go", "Java": ".java",
...
def login():
    s.post("https://leetcode-cn.com/accounts/login/", data={
        "login": username,
        "password": password
    }, headers={
...
def fetch_list():
    ...
    while True:
        ...
        res = s.get("https://leetcode-cn.com/api/submissions/", params={
            "offset": (cur_page - 1) * 40,
            "limit": 40
        }).json()
...
def fetch_record(record_id):
    post_data = {
        "operationName": "mySubmissionDetail", "variables": {"id": str(record_id)},
    ...
    res = s.post("https://leetcode-cn.com/graphql/",
